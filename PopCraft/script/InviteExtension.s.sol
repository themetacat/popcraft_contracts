...
import { InviterV2, InviteCodeToInviter, PlayerToInviteV2, InvitationScoreRecord } from "../src/codegen/index.sol";
import { InviteSystem } from "../src/systems/InviteSystem.sol";
...
contract InviteExtension is Script {
  function run() external {
    ...
    ResourceId systemResource = WorldResourceIdLib.encode(RESOURCE_SYSTEM, "popCraft", "InviteSystem");
    ...
    InviterV2.register();
    InviteCodeToInviter.register();
    PlayerToInviteV2.register();
    InvitationScoreRecord.register();

    InviteSystem inviteSystem = new InviteSystem();
    console.log("SYSTEM_ADDRESS: ", address(inviteSystem));
    world.registerSystem(systemResource, inviteSystem, true);
